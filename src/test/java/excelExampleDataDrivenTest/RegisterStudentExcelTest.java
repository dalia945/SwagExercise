package excelExampleDataDrivenTest;
...
public class RegisterStudentExcelTest {
    ...
    //set the Chrome Driver path
        ...
        WebElement genderMale= driver.findElement(By.xpath("(//div[contains(@class,'custom-control custom-radio')])[2]"));
        ...
        for(int i=1;i<=excelUtils.getRowCountInSheet();i++)
        {
            ...
            genderMale.click();
            mobile.clear();
//            int a = excelUtils.getCellData(i,3);
